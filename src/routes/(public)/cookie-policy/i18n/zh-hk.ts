...
export default {
	...
	whatAreCookies: {
		title: '什麼是Cookie？',
		body: 'Cookie是您瀏覽本網站時，儲存於您裝置上的小型文字檔案。它們有助網站更有效運作，讓我們保留您的語言偏好設定（例如英語／西班牙語），並向我們的團隊提供匿名分析數據。'
	},
	categories: {
		title: '我們使用的Cookie類別',
		items: [
			{
				title: '必要及技術性Cookie',
				body: '對基本瀏覽、安全性及語言偏好設定的持續運作極為重要，無法關閉。'
			},
			{
				title: '分析及效能Cookie',
	...
	managing: {
		title: '管理您的偏好設定',
		body: '您可透過個人瀏覽器偏好設定，輕鬆拒絕或封鎖Cookie。不過，請注意封鎖所有Cookie可能影響您使用進階功能，例如自動填寫表格或保留語言選擇等。'
	}
} satisfies Copy;
