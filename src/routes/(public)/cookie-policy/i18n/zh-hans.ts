...
const copy = {
	...
	whatAreCookies: {
		title: '什么是Cookie？',
		body: 'Cookie是您访问我们网站时存储在您设备上的小型文本文件。它们有助于网站更高效地运行，使我们能够记住您选择的浅色或深色主题，并为我们的团队提供匿名分析数据。'
	},
	categories: {
		title: '我们使用的Cookie类别',
		items: [
			{
				title: '必要及技术性Cookie',
				body: '对基本导航、安全性及记住您的浅色或深色主题至关重要，无法关闭。'
			},
			{
				title: '分析及性能Cookie',
	...
	managing: {
		title: '管理您的偏好设置',
		body: '您可以通过浏览器的个人设置轻松拒绝或屏蔽Cookie。但请注意，限制所有Cookie可能会影响您使用某些高级功能，例如表单自动填写或记住您的浅色或深色主题。'
	}
} satisfies Copy;
