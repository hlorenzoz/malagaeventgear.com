...
export default {
	seo: {
		title: 'Vårt team av tekniker i Malaga | MEG',
		description:
	...
	sales: {
		title: 'Säljteam',
		subtitle: 'Kundstöd och bokning',
		body: 'Vårt säljteam guidar dig genom valet av det perfekta paketet och hjälper dig att få din skräddarsydda offert för att slutföra din bokning.'
	},
	hector: {
