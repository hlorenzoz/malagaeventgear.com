...
const copy = {
	...
	intro: {
		title: 'Inleiding en aanvaarding van de voorwaarden',
		body: 'Door gebruik te maken van de diensten van Malaga Event Gear (MEG) ga je akkoord met deze algemene voorwaarden. Malaga Event Gear biedt professionele verhuur van geluid, verlichting en evenementapparatuur voor uiteenlopende gelegenheden, waaronder bruiloften, privéfeesten, bedrijfsevenementen, vergaderingen en MICE-conferenties.'
	},
	scope: {
