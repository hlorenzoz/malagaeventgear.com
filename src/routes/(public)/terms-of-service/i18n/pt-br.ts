...
export default {
	...
	booking: {
		...
		p2: 'Todos os preços listados no nosso site são apresentados sem o IVA (+21%) incluído. Garantimos que todas as transações de pagamento são 100% seguras e processadas por meio de gateways financeiros confiáveis.'
	},
	obligations: {
