...
export default {
	...
	scope: {
		...
		p1: 'Somos especializados em sistemas acústicos PA ativos de alta fidelidade, soluções profissionais de iluminação (barras de LED, um refletor Fresnel com zoom e um kit de uplighting sem fio), unidades de projeção de alto brilho, microfones (com fio, sem fio e gooseneck), uma máquina de fumaça e plataformas de palco.',
