...
const copy = {
	...
	scope: {
		...
		p1: "Nous sommes spécialisés dans les systèmes de sonorisation PA actifs haute fidélité, les solutions d'éclairage professionnelles (barres LED, un projecteur Fresnel à zoom et un kit d'uplighting sans fil), les vidéoprojecteurs à forte luminosité, les microphones (filaires, sans fil, col de cygne), une machine à fumée et les plateaux de scène.",
