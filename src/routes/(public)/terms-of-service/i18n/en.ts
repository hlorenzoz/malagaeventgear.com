...
const copy = {
	...
	limits: {
		...
		p3: 'To guarantee absolute technical accuracy for our international audience, all communication, documentation, and interface bookings are conducted solely in English.'
	},
	booking: {
