...
export default {
	...
	scope: {
		title: '服務範圍及提供項目',
		p1: '我們專門提供高保真主動式PA音響系統、專業燈光方案（LED射燈燈排、變焦菲涅爾聚光燈及無線上照氣氛燈套裝）、高流明投影裝置、咪高峰（有線、無線、鵝頸式）、一部煙霧機，以及舞台平台。',
	...
	booking: {
		title: '預約、定價及保安',
		p1: '所有服務均須至少提前24小時預約。為完成預約，客戶須提供活動的準確地點及時間。',
		p2: '本網站所列的所有價格，均不包含增值稅（另加{vat}）。我們保證所有付款交易皆100%安全，並透過可信賴的金融支付平台處理。'
	},
	obligations: {
		title: '客戶義務及器材責任',
		body: '客戶須負責確保預定地點及時間內，場地入口及所需電源插座均可正常使用。客戶確認正在租借的是高質素專業器材，並須在約定的租借期間內，確保器材的安全及完好狀態。'
	}
} satisfies Copy;
