...
const copy = {
	...
	hero: {
		...
		intro:
			'Tout ce que vous devez savoir sur nos locations de matériel audiovisuel professionnel, nos livraisons, nos installations et notre processus de réservation.'
	},
	filters: {
		all: 'Toutes les questions',
		services: 'Services et matériel',
		logistics: 'Logistique et zones',
		booking: 'Réservation et délais',
		contact: 'Contact'
	}
} satisfies Copy;
