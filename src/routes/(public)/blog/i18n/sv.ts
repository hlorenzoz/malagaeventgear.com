...
export default {
	seo: {
		title: 'Eventteknikblogg med experttips | Malaga Event Gear',
		description:
	...
	newsBadge: 'Nyheter',
	readMore: 'Läs mer →',
	clustersHeading: 'Huvudteman vi täcker',
	clusters: ['Bröllop', 'Företags-AV', 'Ljudakustik', 'Scenbelysning', 'Projicering', 'Privata fester'],
	cta: {
		advice: 'Få teknisk rådgivning',
		packages: 'Utforska paket'
	}
} satisfies Copy;
