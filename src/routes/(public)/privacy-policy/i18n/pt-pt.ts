			...
			rows: [
				{
					...
					purpose:
						'Nome, email, telefone ou identificação de WhatsApp para finalizar os detalhes, coordenar a logística e confirmar a sua reserva. Realizado exclusivamente em inglês.'
				},
				{
