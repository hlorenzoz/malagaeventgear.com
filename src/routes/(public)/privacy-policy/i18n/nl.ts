...
const copy = {
	...
	whoWeAre: {
		title: 'Wie we zijn',
		body: 'Ons websiteadres is https://malagaeventgear.com. Bij Malaga Event Gear (MEG) zetten we ons in om je persoonlijke gegevens te beschermen en transparante toelichtingen te geven over het gebruik van gegevens.'
	},
	infoCollected: {
		title: 'Welke informatie we verzamelen & het doel',
		intro:
	...
	reviews: {
		...
		body: 'We tonen een UITSTEKENDE beoordeling op basis van geverifieerde Google Bedrijfsprofiel-reviews. De verificatie van reviews verloopt dynamisch via Trustindex, wat garandeert dat de oorspronkelijke bron van alle klantbeoordelingen echt en ongewijzigd is.'
	},
	retention: {
		title: 'Gegevensbewaring & rechten',
		body: 'We bewaren je persoonsgegevens alleen zolang als nodig is om je gecontracteerde audiovisuele diensten af te ronden of te voldoen aan wettelijke verplichtingen. Je hebt onder de AVG volledig recht op inzage, rectificatie, bezwaar of verwijdering van je persoonsgegevens, op elk moment, door contact op te nemen met onze verwerkingsverantwoordelijke.'
	}
} satisfies Copy;
