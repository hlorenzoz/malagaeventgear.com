...
const copy = {
	...
	hero: {
		...
		title: 'About Us',
		intro:
			'Welcome to Malaga Event Gear (MEG), your trusted source for high quality audio visual equipment rentals in Malaga, Spain. We specialize in providing top notch gear for events of all sizes.'
	},
	story: {
		title: 'Our Mission & History',
		p1: 'Malaga Event Gear has been active in the audiovisual industry since 1996 and operating as independent freelancers since 2010. Over three decades, we have developed a passion for flawless events and crystal clear acoustics.',
	...
	cta: {
		...
		body: 'Explore our preconfigured packages or request a completely custom quote from our technical team.',
