...
export default {
	...
	story: {
		title: '我們的使命與歷史',
		p1: 'Malaga Event Gear自1996年起投身視聽業界，並自2010年起以自僱形式獨立營運。近三十年來，我們一直對完美無瑕的活動及清晰音效充滿熱誠。',
		p2: '我們採用純送貨到場模式，由我們直接搭建，因此並無設立實體門市。相反，我們會把頂級系統、線材及支援服務，直接帶到馬拉加及太陽海岸各地的別墅、酒店或場地。'
	},
	stats: {
		experienceTitle: '年經驗',
		experienceBody: '專業視聽業界經驗',
		clientsTitle: '滿意客戶',
		clientsBody: '遍佈太陽海岸各地'
	},
	offer: {
		title: '我們提供的服務',
		intro:
		...
		screens: {
			title: '熒幕與投影機',
			body: '高達5,000流明的投影機及投影幕，適合簡報、會議及戶外電影放映活動。'
		},
		microphones: {
			title: '咪高峰',
		...
		effects: {
			title: '特效',
			body: '專業Martin Magnum 650煙霧機，為舞池及舞台增添氣氛。'
		}
	},
	cta: {
		title: '準備好提升您下一場活動的水準？',
		body: '瀏覽我們預先配置的套餐，或向我們的技術團隊申請完全度身訂造的報價。',
		packages: '查看價格套餐',
		contact: '直接聯絡我們'
	}
} satisfies Copy;
