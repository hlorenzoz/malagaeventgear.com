...
export default {
	...
	stats: {
		...
		experienceBody: 'In der professionellen AV-Branche',
		clientsTitle: 'Zufriedene Kunden',
		clientsBody: 'An der gesamten Costa del Sol'
	},
	offer: {
	...
	cta: {
		title: 'Bereit, Ihre nächste Veranstaltung aufzuwerten?',
		body: 'Entdecken Sie unsere vorkonfigurierten Pakete oder fordern Sie ein individuelles Angebot von unserem technischen Team an.',
		packages: 'Preise & Pakete ansehen',
