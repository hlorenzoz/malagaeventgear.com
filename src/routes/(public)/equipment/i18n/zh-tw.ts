...
export default {
	seo: {
		...
		description:
			'探索我們高品質的專業音響系統、動態燈光、高畫質投影機與特殊效果庫存，這是馬拉加投影機螢幕燈光音響出租的頂級設備目錄。'
	},
	schema: {
	...
	hero: {
		...
		titlePart2: '提升您的活動',
		subtitle:
			'探索我們高保真音響、絢麗燈光與特殊效果的完整目錄。我們擁有讓您的慶祝活動難忘所需的完美工具。'
	},
	featured: {
	...
	catalog: {
		title: '技術類別',
		subtitle: '瀏覽我們的庫存，滿足您製作活動的各項技術需求。'
	},
	audio: {
		imageAlt: '專業音響租賃設備',
	...
	visuals: {
		...
		desc: '最高達5000流明的投影機、投影幕，以及60吋顯示面板，帶給觀眾清晰銳利的視覺體驗。'
	},
	effects: {
		imageAlt: '活動專用專業煙霧機',
		title: '特殊效果',
		desc: '專業的Martin Magnum 650煙霧機，增添氛圍並讓舞池上的燈光光束清晰可見。'
	}
} satisfies Copy;
