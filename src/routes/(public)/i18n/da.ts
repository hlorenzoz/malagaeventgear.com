...
const copy = {
	seo: {
		title: 'Leje af AV-udstyr i Malaga | MEG',
		description:
	...
	faqSection: {
		...
		seeAllFaqs: 'Se alle FAQ'
	},
	posts: {
		latestTitle: 'Seneste indlæg',
		latestViewAll: 'Se alle indlæg',
		newsTitle: 'Seneste nyheder',
		newsViewAll: 'Se alle nyheder'
	}
} satisfies Copy;
