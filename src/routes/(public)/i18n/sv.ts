...
export default {
	seo: {
		title: 'Hyra eventteknik i Malaga | MEG',
		description:
	...
	faqSection: {
		...
		seeAllFaqs: 'Se alla vanliga frågor'
	},
	posts: {
		latestTitle: 'Senaste inläggen',
		latestViewAll: 'Se alla inlägg',
		newsTitle: 'Senaste nyheterna',
		newsViewAll: 'Se alla nyheter'
	}
} satisfies Copy;
