...
const copy = {
	...
	hero: {
		imageAlt: 'Premium evenementpodium met professionele audiovisuele verlichting aan de Costa del Sol'
	},
	categories: {
	...
	faqSection: {
		...
		seeAllFaqs: 'Bekijk alle veelgestelde vragen'
	},
	posts: {
		latestTitle: 'Laatste berichten',
		latestViewAll: 'Bekijk alle berichten',
		newsTitle: 'Laatste nieuws',
		newsViewAll: 'Bekijk al het nieuws'
	}
} satisfies Copy;
