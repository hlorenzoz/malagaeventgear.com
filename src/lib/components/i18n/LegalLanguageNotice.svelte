<script lang="ts">
	...
	// On a translated legal page the English version prevails (confirmed by the business,
	// 2026-09-24). Goes at the very top of every translated legal page. Nothing in English.
	let { enPath }: { enPath: string } = $props();
</script>
