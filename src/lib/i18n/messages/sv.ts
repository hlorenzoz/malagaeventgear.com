...
const t = {
	...
	filters: {
		...
		priceLow: 'Upp till 300 €',
		priceMid: '300 till 500 €',
		priceHigh: '500 € och uppåt',
	...
	contact: {
		...
		lockedFieldNote: 'Automatiskt genererat från ett fel. Detta fält kan inte redigeras.',
		errorPrefillMessage:
	...
	leadForm: {
		...
		submitBtn: 'Kontrollera datumets tillgänglighet',
		submitting: 'Skickar...',
		...
		errorMinLength: 'Måste vara minst 2 tecken.',
		errorMaxLength: 'Max 1000 tecken tillåtna.',
		...
		emailFailBody: 'Din förfrågan sparades, men vårt e-postsystem misslyckades med att skicka den. Kontakta vårt team direkt så att vi inte tappar bort din förfrågan.',
		emailFailAction: 'Kontakta teamet',
		emailFailDismiss: 'Stäng',
		countryCode: 'Landskod',
		responseTime: 'Vi svarar så snart som möjligt',
		trustBadge: 'Betrodd av 500+ evenemang i Malaga'
	},
	// Thank-you page
	thankYou: {
	...
	errorPage: {
		...
		notFoundBody: 'Sidan du letar efter finns inte eller har flyttats. Prova från startsidan eller kontakta oss.',
