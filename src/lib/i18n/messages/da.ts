...
const t = {
	...
	categories: {
		...
		fxTitle: 'Specialeffekter og røgmaskiner',
		fxText: 'Skab en fantastisk stemning til dit event med vores professionelle specialeffekter og røgmaskiner.',
	...
	filters: {
		...
		priceLow: 'Op til 300 €',
		priceMid: '300 til 500 €',
		priceHigh: '500 € og derover',
	...
	process: {
		...
		s4Desc: 'Vi står for opsætning, kører showet og pakker det hele sammen bagefter. Nul stress for dig.'
	},
	// Pricing Preview
	pricingPreview: {
		badge: 'Gennemsigtige priser',
	...
	// Gallery
	gallery: {
		titleHome: 'Vores events i aktion',
		titlePackage: 'Tidligere {pack}-events'
	},
	// Google Map / Profile
	googleMap: {
