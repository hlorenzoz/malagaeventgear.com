...
const t = {
	...
	process: {
		...
		s4Title: '享受您的活動',
		s4Desc: '我們負責運送、搭建與測試所有設備，並在活動結束後收回，讓您零壓力享受活動。'
	},
	// Pricing Preview
	pricingPreview: {
		badge: '透明定價',
	...
	blogStructure: {
		...
		highlightsHeadings: ['重點', '要點', '亮點'],
		testimonialsHeadings: ['客戶評價', '客戶評論'],
		tocHeadings: ['目錄'],
		inThisArticle: '本文內容',
		tocAria: '目錄',
		faqAria: '常見問題'
	...
	postCta: {
		...
		headline: {
			...
			'basic-mice': '正在籌辦企業活動？',
			mice: '需要高階會展視聽支援？',
			'product-presentation': '要發表新產品或進行簡報？',
			eco: '正在籌備私人活動？'
		},
		subline: {
			wedding: '選擇{name}：專業音響與浪漫燈光，為您的大日子增色。',
			'basic-mice': '選擇{name}：清晰的視聽設備，適合高階主管會議與研討會。',
			mice: '選擇{name}：高階LED顯示器、音響及現場技術人員。',
			'product-presentation': '選擇{name}：高亮度投影機、布幕與音響，讓簡報更有感染力。',
