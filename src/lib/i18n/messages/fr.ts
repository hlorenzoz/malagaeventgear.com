...
const t = {
	...
	filters: {
		...
		priceLow: "Jusqu'à {price:budgetLow}",
		priceMid: '{price:budgetLow} à {price:budgetHigh}',
		priceHigh: '{price:budgetHigh} et plus',
	...
	// Gallery
	gallery: {
		titleHome: 'Cadres et idées pour vos événements',
		titlePackage: '{pack} : cadres et idées'
	},
	// Google Map / Profile
	googleMap: {
