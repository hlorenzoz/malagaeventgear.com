...
export default {
	packages: {
		eco: {
			updated: '2026-09-24',
			desc: "Idéal pour les fêtes privées ou les petits événements jusqu'à 50 invités. Comprend un système de son solide et un éclairage d'ambiance.",
			includes: [
			...
			landing: {
				...
				highlightBody:
					"Nous fonctionnons uniquement en livraison avec installation directe. Nous apportons le matériel, l'installons de façon professionnelle, testons le son et les lumières, puis récupérons le tout après l'événement.",
		...
		wedding: {
			...
			includes: [
				"Système de sonorisation PA actif haut de gamme pour jusqu'à 80 invités",
				"Guirlandes lumineuses / rubans LED chauds pour un éclairage d'ambiance romantique",
			...
			landing: {
				...
				specBody: 'Idéal pour les magnifiques villas, fincas et hôtels de mariage.',
				highlightTitle: 'Technicien en direct sur place',
				highlightBody:
					'Ne vous souciez plus des larsens ou des problèmes visuels. Ce forfait comprend un suivi technique complet en direct et des réglages acoustiques tout au long de votre banquet et de vos discours.',
				includesLabel: 'Prestations premium incluses',
				ctaHeading: 'Rendez votre célébration magique',
				ctaBody:
					"Les réservations de mariage se remplissent vite. Réservez votre date dès aujourd'hui avec notre équipe technique pour garantir le plus beau son et l'éclairage romantique le jour J.",
				ctaButton: 'Réserver ce Wedding Pack'
			}
		},
		'product-presentation': {
			updated: '2026-09-24',
			desc: "Conçu pour les présentations d'entreprise, les showrooms concessionnaires et les lancements de produits à fort impact visuel.",
			includes: [
		...
		'basic-mice': {
			...
			includes: [
				...
				"Système de sonorisation de base au son cristallin pour jusqu'à 40 personnes",
		...
		mice: {
			...
			includes: [
				...
				"1 technicien audiovisuel spécialisé dédié en direct (jusqu'à 6 heures de support continu)",
			...
			landing: {
				...
				includesLabel: 'Prestations premium incluses',
				optionalLabel: 'Options supplémentaires',
				ctaHeading: "Donnez de la puissance à votre événement d'entreprise",
				ctaBody:
	...
	faqs: {
		'what-is-meg': {
			question: "Qu'est-ce que Malaga Event Gear (MEG), et quels services proposent-ils ?",
			answer:
				"Malaga Event Gear (MEG) est une entreprise basée à Malaga, en Espagne, spécialisée dans la location de matériel audiovisuel, d'éclairage et d'événementiel professionnel. Nous proposons des systèmes de son, vidéoprojecteurs, écrans, scènes, assistance technique, machines à fumée, solutions d'éclairage et microphones, ainsi que des services spécialisés comme le renforcement sonore en direct, et la traduction simultanée et les systèmes de vote interactif organisés avec un partenaire sous-traitant."
		},
		'event-types': {
		...
		'language-hours': {
			question: "Dans quelle langue communiquent-ils avec les clients, et quels sont leurs horaires d'ouverture ?",
			answer:
				'Malaga Event Gear (MEG) communique avec ses clients principalement en anglais, et tous les services sont proposés en anglais pour servir notre clientèle internationale. Nous sommes disponibles 24 heures sur 24 et 7 jours sur 7 pour les installations techniques et le suivi en direct des événements.'
		},
		'contact-info': {
		...
		'large-scale-events': {
			...
			answer:
				"Absolument. En plus des mariages et réunions d'entreprise, nous équipons des événements de plus grande envergure comme les congrès, salons et expositions avec des solutions audiovisuelles sur mesure, combinant renforcement sonore, écrans grand format, murs vidéo, scènes et personnel technique dédié selon les besoins."
		},
		'notice-time': {
			question: 'Quel est le délai minimum pour effectuer une réservation ?',
			answer:
				"Toute location de matériel événementiel et tout service technique doit être réservé au moins 24 heures à l'avance pour garantir la disponibilité en termes de planning et de logistique. Pour les événements importants ou complexes, nous recommandons de réserver le plus tôt possible pour sécuriser votre date."
		},
