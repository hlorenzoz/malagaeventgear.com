...
export default {
	...
	faqs: {
		'what-is-meg': {
			...
			answer:
				'Malaga Event Gear（MEG）是一家总部位于西班牙马拉加的公司，专注于提供专业视听、灯光及活动设备租赁服务。我们提供音响系统、投影仪、屏幕、舞台、技术协助、烟雾机、灯光方案及麦克风，并提供现场扩声等专项服务，以及通过合作伙伴分包安排的同声传译与互动投票系统。'
		},
		'event-types': {
		...
		'equipment-brands': {
			question: '你们使用哪些设备品牌？',
			answer:
				'我们选用现场活动行业信赖的高端专业品牌，音响方面采用Audix与HK Audio，灯光方面采用Eurolite与ADJ，烟雾特效采用Martin。这确保每笔预订都能获得可靠的高保真音效与灯光表现。'
		},
		'delivery-only': {
		...
		'streaming-recording': {
			...
			answer:
				'不提供。我们不提供摄像机、直播编码器、多机位视频制作或录制服务。我们负责场地的音响、屏幕与灯光，如需举办混合或虚拟活动，请自行准备笔记本电脑、直播软件及网络连接。'
		},
		'translation-voting': {
		...
		'customize-package': {
			...
			answer:
				'当然可以。每款套餐都可以添加投影仪与投影幕布、专业烟雾机、额外麦克风、高端亚克力讲台、模块化舞台搭建及额外现场技术人员时长等附加项目。申请报价时请告知我们您的需求，我们将为您的活动量身打造完美配置。'
		}
	}
} satisfies DataCopy;
