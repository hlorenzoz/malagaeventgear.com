...
export default {
	packages: {
		eco: {
			...
			optional: ['投影機及投影幕（+50€）', '專業煙霧機（+20€）'],
			seo: { title: 'Eco Pack音響燈光租借｜馬拉加小型派對套餐 - Malaga Event Gear' },
			landing: {
				badge: '小型活動與派對',
				rateLabel: '超值全包價格',
				vatNote: '（另加21%增值稅，已含搭建及運送）',
				specTitle: '最多50位賓客',
		...
		mice: {
			updated: '2026-09-24',
			desc: '全方位企業MICE會展方案，配備大型顯示熒幕、優質主動式擴音系統、無線講台咪高峰，以及專屬現場技術人員支援，適用於馬拉加的大型會展音響投影需求。',
			includes: [
				'60吋高清LED顯示熒幕，附設計款腳架',
				'專業主動式喇叭及高效能音響系統',
				'1支鵝頸咪高峰＋1支無線手持咪高峰',
			...
			optional: [
				'額外現場技術支援時數（+40€／小時）',
				'高級亞加力現代講台（+50€）',
				'組合式舞台平台／看台搭建（每平方米+35€）'
			],
			seo: { title: 'MICE Pack企業會展音響投影｜馬拉加大型套餐 - Malaga Event Gear' },
			landing: {
				badge: '尊尚企業MICE體驗',
				rateLabel: '企業全包價格',
				vatNote: '（另加21%增值稅，已含LED顯示熒幕、音響及現場技術人員）',
	...
	faqs: {
		'what-is-meg': {
			...
			answer:
				'Malaga Event Gear（MEG）是一間位於西班牙馬拉加、專營專業視聽、燈光及活動器材租借的公司。我們提供音響系統、投影機、熒幕、舞台、技術協助、煙霧機、燈光方案與咪高峰，並提供現場擴音等專業服務，以及透過合作的外判夥伴安排的同步傳譯及互動投票系統。'
		},
		'event-types': {
		...
		'service-areas': {
			...
			answer:
				'雖然公司名稱有「馬拉加」，但我們的服務範圍遠不止於此市。我們主要服務整個太陽海岸地區，包括馬拉加市中心、馬貝拉、Coín、Ronda、Mijas、Nerja、Torremolinos、Fuengirola、Benalmadena及Estepona。我們亦服務塞維利亞及格拉納達，不過由於格拉納達屬跨省交通距離，一般需要金額超過400€的預約。'
		},
		'what-makes-unique': {
		...
		'vat-pricing': {
			...
			answer:
				'不包含。標示的價格均不包括增值稅。如價格旁標註的（另加21%增值稅）所示，將於套餐價格以外另加西班牙標準21%增值稅（IVA）。您的最終報價將完全透明地列出未稅價格與增值稅明細。'
		},
		'on-site-technician': {
			question: '活動期間你們會提供現場技術人員嗎？',
			answer:
				'會的。部分套餐（例如Wedding Pack及完整版MICE Pack）已包含專屬現場技術人員，全程負責技術控制及工程支援。若套餐未包含此服務（例如Basic MICE Pack），可加購現場技術協助，價格由每日240€起。'
		},
		'equipment-brands': {
			question: '你們使用哪些器材品牌？',
			answer:
				'我們選用現場活動業界信賴的頂級專業品牌，包括音響方面的Audix及HK Audio、燈光方面的Eurolite及ADJ，以及煙霧特效的Martin。這確保每項預約都能享有穩定可靠、高保真的音響及燈光表現。'
		},
		'delivery-only': {
		...
		'streaming-recording': {
			...
			answer:
				'不提供。我們並無提供攝影機、直播編碼器、多機位影片製作或錄影服務。我們負責提供場地音響、熒幕及燈光；若為混合式或網上活動，請自行準備手提電腦、直播軟件及網絡連線。'
		},
		'translation-voting': {
		...
		'minimum-order-granada': {
			...
			answer:
				'在太陽海岸地區內沒有特別的最低消費限制。對於較遠、跨省的目的地（例如格拉納達），我們要求最低租借金額須超過400€，以涵蓋單日往返的物流成本。我們亦提供塞維利亞地區的服務，請與我們聯絡以確認您所在地點的具體條件。'
		},
		'customize-package': {
			question: '我可以根據自身需求度身訂造或延伸套餐內容嗎？',
			answer:
				'可以。每個套餐都可以加購項目延伸，例如投影機及熒幕、專業煙霧機、額外咪高峰、高級亞加力講台、組合式舞台平台，以及額外的現場技術人員時數。申請報價時請告訴我們您的需求，我們將為您的活動打造最完美的配置。'
		}
	}
} satisfies DataCopy;
