...
const faqData: FaqItem[] = [
	...
	},
	{
		...
		answer: {
			en: 'We use premium professional brands trusted in the live-event industry, including Audix, HK Audio, and Martin, among others. This ensures reliable, high-fidelity sound and lighting performance for every booking.',
			es: 'Usamos marcas profesionales premium de confianza en la industria de eventos en vivo, incluyendo Audix, HK Audio y Martin, entre otras. Esto garantiza un rendimiento de sonido e iluminación fiable y de alta fidelidad en cada reserva.'
		}
	},
	{
		id: 'delivery-only',
