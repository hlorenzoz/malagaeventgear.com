 ...
 * if you want a localized version of a specific review shown when the page language
 * matches, add an entry keyed by the testimonial `id`.
 *
...
export const reviewTranslationOverrides: Record<string, LocalizedText> = {
	// Example (commented): translate the Chinese review for English readers.
	// 'ting-ting-yu': {
