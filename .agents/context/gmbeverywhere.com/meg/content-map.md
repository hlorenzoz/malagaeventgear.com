...
| 2 | Headset microphone rental | covered | audiovisual-equipment-rental-service | 1 | RESOLVED 2026-07-31: business confirmed 2x Audix RAD-360 lavalier sets + 1x Audix HT5 headband mic are real (Equipamiento.csv). sound-system-rental.svx and the pillar corrected from "we don't offer" to "separate item, not bundled into packages." No separate page. |
...
| 17 | Stage uplighting | **ready** | stage-uplighting | 2 | RESOLVED 2026-07-31: business confirmed the ADJ Element H6 Pack (6 fixture wireless battery uplighting kit) is real. Already given a short mention on the pillar and on lighting-ideas-for-wedding-rentals.svx (both corrected from a flat denial), but a dedicated page is a genuine candidate given it's a real, distinct, previously-undocumented product - one of the few honest additions to the audiovisual-equipment-rental-service pillar's orphan supporting cluster. |
...
- Category 6: row 1 Stage lighting rental (absorbs category 5 row 34 "Stage lighting installation" as a duplicate), row 17 Stage uplighting (new 2026-07-31, real ADJ Element H6 Pack wireless uplighting kit, absorbs row 18 "Wireless stage lighting" as a synonym, and is a real candidate for the audiovisual-equipment-rental-service pillar's orphan supporting cluster), row 19 Stage lighting for weddings, row 20 Sound and lighting packages, row 45 Outdoor event lighting
